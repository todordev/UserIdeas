 ...
 * @since        3.1.2
 */
class UserideasObserverAttachment extends JTableObserver
{
    /**
    ...
    public function onBeforeDelete($pk)
    {
        if ((int)$this->table->get('id') > 0) {
            ...
            $file         = $filesystemHelper->getMediaFolder($this->table->get('item_id'), Userideas\Constants::ITEM_FOLDER) .'/'. $this->table->get('filename');
