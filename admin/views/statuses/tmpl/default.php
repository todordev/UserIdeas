...
<form action="<?php echo JRoute::_('index.php?option=com_userideas&view=statuses'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container" class="span10">
        ...
        <div id="filter-bar" class="btn-toolbar">
            <div class="filter-search btn-group pull-left">
    			...
    			<input type="text" class="hasTooltip" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('COM_USERIDEAS_SEARCH_IN_NAME'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_USERIDEAS_SEARCH_IN_NAME_TOOLTIP'); ?>" />
    		</div>
        ...
        <table class="table table-striped" id="statusesList">
